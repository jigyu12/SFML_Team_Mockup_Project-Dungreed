...
#define TILE_TABLE (DATATABLE_MGR.Get<TileTable>(DataTable::Types::Tile))
#define RESOURCEID_TABLE (DATATABLE_MGR.Get<ResourceIdTable>(DataTable::Types::ResourceId))
